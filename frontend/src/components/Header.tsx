      ...
      <div className="header-right">
        ...
        <button className="header-icon-btn" title="設定" onClick={onSettingsClick}>
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <path d="M10 1V3M10 17V19M19 10H17M3 10H10 1M16.364 3.636L15 5M5 15L3.636 16.364M16.364 16.364L15 15M5 5L3.636 3.636" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        </button>
